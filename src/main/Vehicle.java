...
public class Vehicle{
	...
	public void turn(String dir, double degree){ 
		...
		if(dir == "LEFT"){ 
			...
			if(turnRight-degree<0) turnRight = 360-Math.abs(turnRight-degree);
			else turnRight = turnRight-degree; 
			}
		else {
 			turnRight = (turnRight+degree)%360;
			if(turnLeft-degree<0) turnLeft = 360-Math.abs(turnLeft-degree);
			else turnLeft = turnLeft-degree;
			} 
		}
