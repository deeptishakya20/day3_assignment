...
public class VehicleTest{
	...
	@Test public void checkWhenInputIsValid(){
  	...
  	@Test public void checkSpeedChange() {

 		vehicle[0].changeSpeed(100); assertEquals(100,vehicle[0].getSpeed(),0.2);

 	} 


  	@Test public void checkTurn() {
